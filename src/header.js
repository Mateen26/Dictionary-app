...
const Header = () => {
  ...
  return (
    <header className={`text-gray-600 body-font ${theme === 'dark' ? 'dark' : 'light'}`}>
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">

        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" className={`${theme === "dark" ? "dark" : "light"}`}>
        ...
        <div className='justify-between'>
          <div className="relative inline-flex mr-3 sm:mr-5">
            <svg className="w-3 h-2 absolute top-0 right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232">
          ...
          <label className="inline-block pl-[0.15rem] hover:cursor-pointer"
            ...
            <img style={{ maxWidth: '20px' }} src={theme === 'dark' ? moon : sun} alt="theme icon" />
          </label>
        </div>
      </div>
    </header>
